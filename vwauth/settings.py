...
class Config(object):
    ...
    # security
    SECURITY_REGISTERABLE = config('VWAUTH_SECURITY_REGISTERABLE', True,cast=bool)
    SECURITY_RECOVERABLE = config('VWAUTH_SECURITY_RECOVERABLE', True,cast=bool)
    SECURITY_TRACKABLE = config('VWAUTH_SECURITY_TRACKABLE', True,cast=bool)
    SECURITY_CONFIRMABLE = config('VWAUTH_SECURITY_CONFIRMABLE', True,cast=bool)
